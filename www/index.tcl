...
set action_url "/intranet-crm-opportunities/index"
set form_mode "edit"
...
if {$filter_advanced_p} {
	...
	-page_url "/intranet-crm-opportunities/index"
    ...
    if {$admin_p} {
	set filter_admin_url [export_vars -base "/intranet-dynfield/layout-position" {{object_type im_project} {page_url "/intranet-crm-opportunities/index"}}]
...
ns_log Notice "/intranet-crm-opportunities/index: Before limiting clause"
...
ns_log Notice "/intranet-crm-opportunities/index: Before formatting filter"
set mine_p_options [list \
	[list $all_l10n "f" ] \
	[list [lang::message::lookup "" intranet-core.Mine "Mine"] "t"] \
]
...
ns_log Notice "/intranet-crm-opportunities/index: Before admin links"
set admin_html "<ul>"
...
ns_log Notice "/intranet-crm-opportunities/index: Before format header"
...
ns_log Notice "/intranet-crm-opportunities/index: Before db_foreach"
...
ns_log Notice "/intranet-crm-opportunities/index: before table continuation"
...
# Opportunity Navbar goes to the top
#set project_navbar_html [\
#			     im_project_navbar \
#			     "/intranet-crm-opportunities/index" \
#			     $next_page_url \
#			     $previous_page_url \
#			     $pass_through_vars \
#			     $menu_select_label \
